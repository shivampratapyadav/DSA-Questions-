...
import java.util.*;
public class cwa04Knights_Tour {
    ...
    public static void main(String[] args) throws Exception {
        ...
        knights_tour(chess,row,col,1);
    }

    public static void knights_tour(int [][] chess, int row, int col, int upcomingMove) {
        ...
        knights_tour(chess, row-2, col+1, upcomingMove+1);
        knights_tour(chess, row-1, col+2, upcomingMove+1);
        knights_tour(chess, row+1, col+2, upcomingMove+1);
        knights_tour(chess, row+2, col+1, upcomingMove+1);
        knights_tour(chess, row+2, col-1, upcomingMove+1);
        knights_tour(chess, row+1, col-2, upcomingMove+1);
